  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100">
          <h2 className="text-lg font-semibold text-gray-800 flex items-center gap-2">
            <span>🗑️</span> Call Deletion History (Last 30 Entries)
          </h2>
        </div>
                  ...
                  <div key={entry.id} className="p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500">@{entry.deletedByName}</div>
                      </div>
      ...
      <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100">
          <h2 className="text-lg font-semibold text-gray-800 flex items-center gap-2">
            <span>🗑️</span> Service Deletion History (Last 30 Entries)
          </h2>
        </div>
        ...
        {loadingServiceHistory ? (
          <div className="px-6 py-8 text-center text-gray-500">
            <div className="text-4xl mb-4">🔄</div>
            <p className="text-lg font-medium">Loading service deletion history...</p>
          </div>
        ) : serviceDeletionHistory.length === 0 ? (
          <div className="px-6 py-8 text-center text-gray-500">
            <div className="text-4xl mb-4">📋</div>
            <p className="text-lg font-medium">No service deletion history</p>
            <p className="text-sm">No bulk service deletions have been performed yet</p>
          </div>
        ) : (
          <>
            {/* Mobile/Tablet Card View */}
