          ...
          {!linkGenerated ? (
            <div className="text-center">
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Generate Service Share Link</h3>
            ...
            <div>
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Service Link Generated Successfully!</h3>
                <p className="text-gray-600 text-xs sm:text-sm px-2">
              ...
              <div className="mb-4 sm:mb-6">
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Service Share Link:</label>
                <div className="flex gap-1 sm:gap-2">
                  ...
                  <button
                    ...
                    className="px-2 sm:px-4 py-2 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-xs sm:text-sm font-medium whitespace-nowrap"
                  >
                    📋 Copy
                  </button>
                </div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                <div className="flex items-start gap-2 sm:gap-3">
                  <span className="text-purple-600 text-base sm:text-lg">ℹ️</span>
                  <div className="text-left">
                    <h4 className="font-medium text-purple-800 mb-1 text-sm sm:text-base">How it works:</h4>
