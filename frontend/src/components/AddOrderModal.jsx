            ...
            <div className="space-y-4">
              ...
              {selectedFirm && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-xs font-medium text-blue-600 mb-1">Selected Firm</p>
                  <p className="font-semibold text-gray-800">{selectedFirm.firmName}</p>
                  <p className="text-xs text-gray-600">{selectedFirm.city}{selectedFirm.area ? ` · ${selectedFirm.area}` : ''}</p>
                  <p className="text-xs text-gray-600">{selectedFirm.contactPerson1Name} · {selectedFirm.contactPerson1Number}</p>
                </div>
              )}
          ...
          {step === 2 && selectedFirm && (
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-1">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Firm Details</p>
                <p className="font-semibold text-gray-800">{selectedFirm.firmName}</p>
                <p className="text-sm text-gray-600">GST: {selectedFirm.gstNo}</p>
                <p className="text-sm text-gray-600">{selectedFirm.city}{selectedFirm.area ? ` · ${selectedFirm.area}` : ''}</p>
                <p className="text-sm text-gray-600">{selectedFirm.contactPerson1Name} · {selectedFirm.contactPerson1Number}</p>
              </div>
