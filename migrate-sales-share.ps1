...
Write-Host "Sales Share - Database Migration" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "This will make createdById nullable for sales entries..." -ForegroundColor Yellow
npx prisma db push
...
Write-Host "2. Test the sales share feature" -ForegroundColor White
Write-Host ""
Read-Host "Press Enter to exit"
